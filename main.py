...
def checker_thread():
    while True:
        ...
        price_data()
        time.sleep(151)
        gc.initialize_hardware("https://www.amazon.ca/s?i=videogames&bbn=8929975011&dc&qid=1649384868&ref=sr_pg_1")
        price_data()
        time.sleep(31)
        ...
        price_data()
        time.sleep(151)
        gc.initialize_hardware("https://www.amazon.ca/s?i=videogames&bbn=8929975011&dc&page=2&qid=1649384769&ref=sr_pg_2")
        price_data()
        time.sleep(31)
        ...
        price_data()
        time.sleep(151)
        gc.initialize_hardware("https://www.amazon.ca/s?i=videogames&bbn=8929975011&dc&page=3&qid=1649384865&ref=sr_pg_3")
        price_data()
        time.sleep(31)
